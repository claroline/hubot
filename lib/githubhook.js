/**
 * This file is an almost exact copy of the "node-github-hook" library
 * by Nathan LaFreniere, modified only to make it use a callback instead
 * of an event emitter at the end of the response treatment (the emitter
 * doesn't seem to work properly inside a hubot script). Original source
 * and license are available at https://github.com/nlf/node-github-hook.
 */
...
function serverHandler(req, res, callback) {
...
var GithubHook = function (options) {
    ...
    var boundHandler = serverHandler.bind(this)

    this.server = Http.createServer((req, res) => {
      boundHandler(req, res, callback)
    });
};
